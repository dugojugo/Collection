...
import { APIFY_CLIENT_DEFAULT_HEADERS, AUTH_FILE_PATH, DEFAULT_LOCAL_STORAGE_DIR, GLOBAL_CONFIGS_FOLDER, INPUT_FILE_REG_EXP, LOCAL_CONFIG_PATH, MINIMUM_SUPPORTED_PYTHON_VERSION, SUPPORTED_NODEJS_VERSION, } from './consts.js';
...
export const getLocalConfigPath = (cwd) => join(cwd, LOCAL_CONFIG_PATH);
