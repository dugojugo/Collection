...
export class RunsResurrectCommand extends ApifyCommand {
    static description = 'Resurrects an aborted or finished Actor Run.';
    static args = {
        runId: Args.string({
            required: true,
    ...
    async run() {
        ...
        if (!resurrectStatuses.includes(run.status)) {
            error({
