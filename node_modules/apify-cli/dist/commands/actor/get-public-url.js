...
export class GetPublicUrlCommand extends ApifyCommand {
    static description = 'Get an HTTP URL that allows public access to a key-value store item.';
    static args = {
        key: Args.string({
            required: true,
    ...
    async run() {
        ...
        if (urlSigningSecretKey) {
            publicUrl.searchParams.append('signature', createHmacSignature(urlSigningSecretKey, key));
        }
        console.log(publicUrl.toString());
    }
}
//# sourceMappingURL=get-public-url.js.map