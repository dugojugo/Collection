...
export class KeyValueStoresRenameCommand extends ApifyCommand {
    static description = 'Renames a key-value store, or removes its unique name.';
    static hiddenAliases = ['kvs:rename'];
    static flags = {
    ...
    async run() {
        ...
        try {
            await existingDataset.keyValueStoreClient.update({ name: unname ? null : newName });
            success({
