...
export class KeyValueStoresDeleteValueCommand extends ApifyCommand {
    static description = 'Delete a value from a key-value store.';
    static hiddenAliases = ['kvs:delete-value'];
    static args = {
        storeId: Args.string({
...
//# sourceMappingURL=delete-value.js.map