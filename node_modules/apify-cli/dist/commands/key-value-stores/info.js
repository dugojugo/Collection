...
export class KeyValueStoresInfoCommand extends ApifyCommand {
    static description = 'Shows information about a key-value store.';
    static hiddenAliases = ['kvs:info'];
    static args = {
        storeId: Args.string({
    ...
    async run() {
        ...
        if (user.plan) {
            ...
            if (pricing) {
                ...
                const usdAmountString = storeCostPerMonth > 1 ? `$${storeCostPerMonth.toFixed(2)}` : `$${storeCostPerHour.toFixed(3)}`;
