...
export class KeyValueStoresLsCommand extends ApifyCommand {
    static description = 'Lists all key-value stores on your account.';
    static hiddenAliases = ['kvs:ls'];
    static flags = {
    ...
    async run() {
        ...
        for (const store of rawKvsList.items) {
            ...
            const statsObject = Reflect.get(store, 'stats');
