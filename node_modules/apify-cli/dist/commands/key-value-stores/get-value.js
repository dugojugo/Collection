...
export class KeyValueStoresGetValueCommand extends ApifyCommand {
    static description = 'Retrieves stored value for specified key. Use --only-content-type to check MIME type.';
    static hiddenAliases = ['kvs:get-value'];
    static flags = {
