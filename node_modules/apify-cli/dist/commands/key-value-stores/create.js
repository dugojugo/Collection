...
export class KeyValueStoresCreateCommand extends ApifyCommand {
    static description = 'Creates a new key-value store on your account.';
    static hiddenAliases = ['kvs:create'];
    static args = {
