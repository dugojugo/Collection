...
import { EMPTY_LOCAL_CONFIG, LOCAL_CONFIG_PATH, MINIMUM_SUPPORTED_PYTHON_VERSION, PYTHON_VENV_PATH, SUPPORTED_NODEJS_VERSION, } from '../lib/consts.js';
...
import { downloadAndUnzip, getJsonFileContent, isNodeVersionSupported, isPythonVersionSupported, setLocalConfig, setLocalEnv, } from '../lib/utils.js';
export class CreateCommand extends ApifyCommand {
    static description = 'Creates an Actor project from a template in a new directory.';
    static flags = {
    ...
    async run() {
        ...
        while (true) {
            ...
            const folderHasFiles = folderExists &&
