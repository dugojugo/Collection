...
export class ActorsStartCommand extends ApifyCommand {
    static description = 'Starts Actor remotely and returns run details immediately.\n' +
    ...
    async run() {
        ...
        const runVersionTaggedAs = Object.entries((actorData.taggedBuilds ?? {})).find(([, data]) => data.buildNumber === run.buildNumber)?.[0];
        ...
        // url
        message.push('', `${chalk.blue('Export results')}: ${datasetUrl}`, `${chalk.blue('View on Apify Console')}: ${url}`);
        simpleLog({
