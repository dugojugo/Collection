...
export class DatasetsPushDataCommand extends ApifyCommand {
    static description = 'Adds data items to specified dataset. Accepts single object or array of objects.';
    static args = {
    ...
    async run() {
        ...
        try {
            ...
            error({
                message: `Failed to parse data as JSON string: ${err.message}`,
            });
            return;
        }
...
//# sourceMappingURL=push-items.js.map