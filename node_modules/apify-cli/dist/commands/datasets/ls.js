...
export class DatasetsLsCommand extends ApifyCommand {
    static description = 'Prints all datasets on your account.';
    static flags = {
    ...
    async run() {
        ...
        for (const dataset of rawDatasetList.items) {
            ...
            const size = Reflect.get(dataset.stats, 's3StorageBytes');
            table.pushRow({
